      ...
      <div className="grid grid-cols-1 gap-5 mt-24 section-container sm:grid-cols-2">
        <div className="card">
          ...
          <div className="mt-8">
            ...
            <p className="mt-5">
            Le marché compétitif oblige les entreprises à investir continuellement dans des projets d’amélioration et à gérer efficacement le risque lié à ces investissements. Conscients de l’importance de ces projets dans l’essor économique du Canada, les gouvernements offrent divers programmes de subventions afin d’aider les entreprises à financer leurs projets et diminuer les risques liés à leurs investissements. Le gouvernement fédéral et les gouvernements provinciaux dépensent environ 35 milliards de dollars par année en subventions aux entreprises. Allez sur
            {' '}
